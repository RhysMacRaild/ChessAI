#include "board.h";
    ...
    void Board::movePiece(Board* currentBoard, int initialRow, int initialCol, int movedTooRow, int movedTooCol) {
    ...
    bool Board::moveCheck(int initRow, int initCol, int newRow, int newCol, bool white) {
    ...
    void Board::moveRook(int row, int col, bool white) {
        bool up = true;
        bool down = true;
        bool left = true;
        bool right = true;
    ...
    void Board::moveBishop(int row, int col, bool white) {
        bool upRight = true;
        bool upLeft = true;
        bool downRight = true;
        bool downLeft = true;
    ...
    Board::Board(Board* currentBoard, int initialRow, int initialCol, int movedTooRow, int movedTooCol) {
    ...
    void Board::addBoardToPossible(Board* possibleBoard) {
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 8; col++) {
    ...
    void Board::submitTurn(Board* newBoard) {
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 8; col++) {
    ...
    char Board::getPositionAsChar(int positionNumber) {
        if (positionNumber == 0) {
            return ' ';
        }
    ...
    void Board::printAllPossibleBoards() {
